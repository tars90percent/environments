...
export type BenchmarkReferenceCategoryId = "agents-professional" | "coding-data" | "knowledge-visual" | "cybersecurity";
...
export const benchmarkReferenceCategories = [
  {
    id: "agents-professional",
    label: { en: "Agents, tools & professional work", zh: "智能体、工具与专业工作" },
    description: { en: "Long-horizon workflows, tool use, web research, desktop work, and professional deliverables.", zh: "长时程工作流、工具使用、网页研究、桌面操作与专业交付物。" },
  },
  {
    id: "coding-data",
    label: { en: "Coding, post-training & spreadsheets", zh: "编程、后训练与电子表格" },
    description: { en: "Repository engineering, program reconstruction, model post-training, and spreadsheet workflows.", zh: "代码库工程、程序重建、模型后训练与电子表格工作流。" },
  },
  {
    id: "knowledge-visual",
    label: { en: "Knowledge, science, visual & documents", zh: "知识、科学、视觉与文档" },
    description: { en: "Academic knowledge, scientific reasoning, visual understanding, long context, and document parsing.", zh: "学术知识、科学推理、视觉理解、长上下文与文档解析。" },
  },
  {
    id: "cybersecurity",
...
export const modelBenchmarks = [
    {
      ...
      publisher: "OpenAI",
      categoryId: "agents-professional",
