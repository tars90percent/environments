...
The CASE source is the private repository [`tars90percent/feishu-codex-agent`](https://github.com/tars90percent/feishu-codex-agent). The portal source is [`tars90percent/env-portal-proto`](https://github.com/tars90percent/env-portal-proto). Railway currently deploys uploaded source snapshots, so a GitHub push does not update production. Deploy and verify CASE before deploying a portal revision that depends on a registry API or migration change.
