...
- Open 40 source-linked public-task profiles across every one of the 33 benchmark families with identified public problems, plus four documented format archetypes for two gated families. The profiles compare task objective, input shape, expected output, evaluation method, and capability pattern without reproducing protected questions.
