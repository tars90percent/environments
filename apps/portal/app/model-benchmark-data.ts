...
export type BenchmarkReferenceCategoryId = "agents-tools" | "coding" | "research-reasoning" | "multimodal-documents" | "cybersecurity";
...
export const benchmarkReferenceCategories = [
  {
    id: "agents-tools",
    label: { en: "Agents & tool use", zh: "Agent 与工具调用" },
    description: { en: "Tool use, computer use, interactive environments, and professional workflows.", zh: "工具调用、Computer Use、交互式环境与专业工作流。" },
  },
  {
    id: "coding",
    label: { en: "Coding & software engineering", zh: "Coding 与软件工程" },
    description: { en: "Code generation, repository engineering, program reconstruction, and model development.", zh: "代码生成、代码库工程、程序重建与模型开发。" },
  },
  {
    id: "research-reasoning",
    label: { en: "Research & reasoning", zh: "研究与推理" },
    description: { en: "Web research, long-context reasoning, factual knowledge, and expert-level science.", zh: "Web Research、长上下文推理、事实知识与专家级科学问题。" },
  },
  {
    id: "multimodal-documents",
    label: { en: "Vision & document understanding", zh: "多模态与文档理解" },
    description: { en: "Visual reasoning, chart understanding, and document parsing.", zh: "视觉推理、图表理解与文档解析。" },
  },
  {
    id: "cybersecurity",
...
export const modelBenchmarks = [
    {
      ...
      scoring: { en: "Judge-panel pairwise Elo", zh: "LLM Judge 两两对比，Elo" },
      toolUse: true,
      access: "public",
      links: [
    ...
    },
    {
      ...
      leaderboardSnapshots: [{
        ...
        caption: { en: "Scale Labs' official full-benchmark comparison. The image reflects the live leaderboard at capture time, rather than a frozen May 2025 result set.", zh: "Scale Labs 的官方完整 Benchmark 对比；图片反映截图时的实时排行榜，而非固定在 2025 年 5 月的结果集。" },
      }],
      links: [
    ...
    },
    {
      ...
      leaderboardSnapshots: [{
        ...
        caption: { en: "Artificial Analysis' official score distribution makes the benchmark's low absolute accuracy and model spread immediately visible.", zh: "Artificial Analysis 的官方得分分布图直观呈现了该 Benchmark 的低绝对准确率及模型间差距。" },
      }],
      links: [
    ...
    },
    {
      ...
      access: "private",
      links: [
        { label: { en: "Benchmark", zh: "Benchmark 说明" }, url: "https://cursor.com/cursorbench" },
    ...
    },
    {
      ...
      leaderboardSnapshots: [{
        ...
        caption: { en: "Scale Labs' official comparison places model pass rates and confidence intervals beside the benchmark methodology.", zh: "Scale Labs 的官方对比将模型通过率、置信区间与 Benchmark 方法并列展示。" },
      }],
      links: [
    ...
    },
    {
      ...
      leaderboardSnapshots: [{
        ...
        capturedAt: "2026-08-31",
        alt: { en: "Official DeepSWE v1.1 leaderboard chart comparing benchmark score and average cost", zh: "DeepSWE v1.1 官方排行榜图表，比较 Benchmark 得分与平均成本" },
    ...
    },
    {
      ...
      leaderboardSnapshots: [{
        ...
        capturedAt: "2026-08-31",
        alt: { en: "Official PostTrainBench v1 bar chart comparing average benchmark performance", zh: "PostTrainBench v1 官方条形图，比较平均 Benchmark 表现" },
    ...
    },
    {
      ...
      categoryId: "multimodal-documents",
    ...
    },
    {
      ...
      access: "public",
      links: [
        { label: { en: "Benchmark article", zh: "Benchmark 文章" }, url: "https://surgehq.ai/blog/chartography" },
