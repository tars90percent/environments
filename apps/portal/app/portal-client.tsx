...
const text = {
  en: {
    ...
    benchmarkDownloadNote: "Includes Harbor tasks from all vendors and submissions in this sample group, regardless of search.",
  ...
  zh: {
    ...
    benchmarkDownloadNote: "包含此样本分组中所有供应商和提交的 Harbor 任务，不受搜索条件影响。",
